...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockWBNBInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "balanceOf" | "burn" | "decimals" | "deposit" | "initialize(string,string,uint8)" | "initialize()" | "mint" | "name" | "symbol" | "totalSupply" | "transfer" | "transferFrom" | "withdraw"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'withdraw', data: BytesLike): Result;
  ...
  export interface MockWBNB extends BaseContract {
    
    connect(runner?: ContractRunner | null): MockWBNB;
    waitForDeployment(): Promise<this>;

    interface: MockWBNBInterface;

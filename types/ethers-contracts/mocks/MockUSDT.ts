...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface MockUSDTInterface extends Interface {
    getFunction(nameOrSignature: "allowance" | "approve" | "balanceOf" | "burn" | "decimals" | "initialize(string,string,uint8)" | "initialize(uint8)" | "mint" | "name" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
encodeFunctionData(functionFragment: 'initialize(string,string,uint8)', values: [string, string, BigNumberish]): string;
encodeFunctionData(functionFragment: 'initialize(uint8)', values: [BigNumberish]): string;
...
decodeFunctionResult(functionFragment: 'initialize(uint8)', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    "initialize(uint8)": TypedContractMethod<
...
getFunction(nameOrSignature: 'decimals'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'initialize(string,string,uint8)'): TypedContractMethod<
      [_name: string, _symbol: string, _decimals: BigNumberish, ],
      [void],
      'nonpayable'
    >;
getFunction(nameOrSignature: 'initialize(uint8)'): TypedContractMethod<
      [usdtDecimals: BigNumberish, ],
      [void],
      'nonpayable'
    >;
